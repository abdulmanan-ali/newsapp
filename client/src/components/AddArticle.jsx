...
import { faFileImage, faUser } from '@fortawesome/free-solid-svg-icons';
...
const AddArticle = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-center mt-9 mb-8 text-red-600 underline">
        {t('AddArticle.addArticle')}
      </h1>
      ...
      <ToastContainer
        ...
        toastClassName="animate__animated animate__slideInRight animate__slideOutLeft"
      />
    </div>
  );
};
