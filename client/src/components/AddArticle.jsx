...
const AddArticle = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-center mt-9 mb-8 text-red-600 underline">Add Article</h1>
      ...
      >
        ...
        <div>
          <label htmlFor="blogTitle" className="block text-sm font-medium text-gray-700 flex items-center">
            <FontAwesomeIcon icon={faUser} className="mr-2" /> Your Name (English)
          </label>
          <input
            type="text"
            id="authorName"
